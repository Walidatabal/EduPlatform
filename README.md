...
## Current Status — Final Production Build (May 2026)
...
**Via PowerShell:**
```powershell
docker exec -it eduplatform-sqlserver-1 /opt/mssql-tools/bin/sqlcmd `
...
docker cp eduplatform-sqlserver-1:/var/opt/mssql/backup/EduPlatformDb.bak ./EduPlatformDb.bak
```
